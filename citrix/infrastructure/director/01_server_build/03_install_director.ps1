...
$UnattendedArgs = '/quiet /configure_firewall /COMPONENTS DESKTOPDIRECTOR /nosql /noreboot'
$Destination = "$Version\x64\XenDesktop Setup\"

# Start the transcript for the install
Start-Transcript $LogPS

# Change to the Citrix Director Directory of the Media
If (Test-Path $Destination) 
{
    Write-Verbose "Changing to Director Install Directory" -Verbose
