...
$logPS = "C:\Windows\Temp\import_and_bind_storefront_certificate.log"
...
If (Test-Path $PSScriptRoot\custom\storefront) 
{
    ...
    $Certificate = Import-PfxCertificate -FilePath $PSScriptRoot\custom\storefront\$CertificateFileName -CertStoreLocation Cert:\LocalMachine\My -Password $SecurePassphrase
} 
Else 
{
